...
namespace OnlineShop.Areas.Admin.Controllers
{
    ...
    public class RoleController : Controller
    {
        ...
        public async Task<IActionResult> Create(string name)
        {
            ...
            if (isExist)
            {
                ViewBag.mgs = "This Role is allready Exist";
                ViewBag.name = name;
                return View();
            }
            ...
            if (result.Succeeded)
            {
                TempData["save"] = "Role has been Saved succcessfully";
        ...
        public async Task<IActionResult> Edit(string id, string name)
        {
            ...
            if (result.Succeeded)
            {
                TempData["save"] = "Role has been updated succcessfully";
                return RedirectToAction(nameof(Index));
            }
            return View();
        ...
        public async Task<IActionResult> DeleteConfirm(string id)
        {
            ...
            if (result.Succeeded)
            {
                TempData["save"] = "Role has been deleted succcessfully";
                return RedirectToAction(nameof(Index));
            }
            return View();
        }
        ...
        public async Task<IActionResult> Assign(RoleUserVm roleUser)
        {
            ...
            {
                ViewBag.msg = "This user allready assign this role";
                ViewData["UserId"] = new SelectList(_db.ApplicationUsers.Where(f => f.LockoutEnd < DateTime.Now || f.LockoutEnd == null).ToList(), "Id", "UserName");
                ViewData["RoleId"] = new SelectList(_roleManager.Roles.ToList(), "Name", "Name");
                return View();
            }
            ...
            if (role.Succeeded)
            {
                TempData["save"] = "User Role Assinged";
                return RedirectToAction(nameof(Index));
            }
            return View();
        }
